...
public class EstudianteDAO {
    ...
    public boolean buscarEstudiantePorId(Estudiante estudiante){
        ...
        try{
            ...
            try{
                ...
                System.out.println("Ocurrió un error al centrar la conexion: " + e.getMessage());
    ...
    public boolean modificarEstudiante(Estudiante estudiante){
        ...
        try{
            ...
            try{
                ...
                System.out.println("Error al cenrrar la conexion "+ e.getMessage());
            } // fin catch
        } //fin finally
        return false;
    ...
    public static void main(String[] args) {
        ...
        var estudianteModificado = new Estudiante(1, "Juan Carlos", "Juarez", "164198498321", "juen@mail.com");
        ...
        //Agregar estudiante
        //var nuevoEstudiante = new Estudiante("Carlos", "Lara", "568413749", "carlosl@mail.com");
